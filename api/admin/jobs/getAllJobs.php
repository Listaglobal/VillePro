...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_GET['trackid'])) {
        ...
        $sortQuery .= ' AND ' . $jobsDBCall::tableName . '.trackid = ?';
        $paramString .= "s";
        $params[] = $status;
    } else {
        $single_post = false;
    ...
    if (isset($_GET['search'])) {
        $tableName = $jobsDBCall::tableName;
    ...
    $AllReview = $jobsDBCall::getAllJobs($page_no, $offset, $noPerPage, $searchQuery, $sortQuery, $paramString, $params);
