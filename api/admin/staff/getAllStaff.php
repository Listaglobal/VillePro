...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_GET['trackid'])) {
        ...
        $sortQuery .= ' AND ' . $staffDBCall::tableName . '.trackid = ?';
        $paramString .= "s";
        $params[] = $status;
    } else {
        $single_post = false;
    ...
    if (isset($_GET['search'])) {
        $tableName = $staffDBCall::tableName;
    ...
    $AllReview = $staffDBCall::getAllStaff($page_no, $offset, $noPerPage, $searchQuery, $sortQuery, $paramString, $params);
